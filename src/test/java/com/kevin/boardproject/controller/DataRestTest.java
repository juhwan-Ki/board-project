package com.kevin.boardproject.controller;
...
@Transactional // DB를 접근하기 때문에 Rollback을 하도록 함 -> 테스트에서는 기본값이 rollback
...
public class DataRestTest {
    ...
    void given_whenRequestingArticles_thenReturnsArticlesJsonResponse() throws Exception {
        ...
        mvc.perform(get("/api/articles"))
                ...
                // application/hal+json 으로 하는 이유
                //rest repository에서 만들어지는 contentType이 application/hal+json이기 때문
    }
